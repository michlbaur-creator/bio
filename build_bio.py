...
CSS = """
  ...
  *{box-sizing:border-box;-webkit-tap-highlight-color:transparent;}
  ...
  .hero .marke{font-family:var(--sans);font-size:clamp(19px,5vw,26px);font-weight:800;
    letter-spacing:.04em;color:#FFD86B;text-shadow:0 1px 6px rgba(0,0,0,.55);margin-bottom:2px;}
...
def write_hub(listing):
    ...
    body = ('<div class="topbar"><a class="topbtn" id="installBtn" href="anleitung.html">📱 Als App aufs Handy</a></div>'
        ...
        '<p class="lead">Dein Lernort zu <a href="https://flora.mibaso.de/">Flora</a> und '
        '<a href="https://fauna.mibaso.de/">Fauna</a>: Interaktive Stationen zum Erkunden, '
        'Verstehen und Ausprobieren. Fülle deinen Forschungspass mit Leben!</p>'
        '<div class="kacheln">'
